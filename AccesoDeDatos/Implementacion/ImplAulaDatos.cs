...
{ 
	...
	{
		public IEnumerable<tb_aula> ListarRegistros(String filtro)
        {
        ...
        public bool GuardarRegistro(tb_aula registro)
        {
            try
            {
                using (SoftwareBDEntities bd = new SoftwareBDEntities())
        ...
        public tb_aula BuscarRegistro(int id)
        {
            using (SoftwareBDEntities bd = new SoftwareBDEntities())
            {
        ...
        public bool EditarRegistro(tb_aula registro)
        {
            try
            {
                using (SoftwareBDEntities bd = new SoftwareBDEntities())
