...
{ 
	...
	{
		public IEnumerable<tb_tipoelemento> ListarRegistros(String filtro)
        {
            ...
            using (SoftwareBDEntities bd = new SoftwareBDEntities())
            {
                ...
                {
                    lista = bd.tb_tipoelemento.ToList();
                }
                else
                {
        ...
        public bool GuardarRegistro(tb_tipoelemento registro)
        {
            try
            {
                using (SoftwareBDEntities bd = new SoftwareBDEntities())
                {
                    ...
                    bd.tb_tipoelemento.Add(registro);
                    bd.SaveChanges();
                    return true;
                }
            }
        ...
        public tb_tipoelemento BuscarRegistro(int id)
        {
            using (SoftwareBDEntities bd = new SoftwareBDEntities())
            {
        ...
        public bool EditarRegistro(tb_tipoelemento registro)
        {
            try
            {
                using (SoftwareBDEntities bd = new SoftwareBDEntities())
