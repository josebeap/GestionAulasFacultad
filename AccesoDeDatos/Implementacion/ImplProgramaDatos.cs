...
{ 
	...
	{
		public IEnumerable<tb_programa> ListarRegistros(String filtro)
        {
            ...
            using (SoftwareBDEntities bd = new SoftwareBDEntities())
            {
                ...
                {
                    lista = bd.tb_programa.ToList();
                }
                else
                {
                    lista = bd.tb_programa.Where(x => x.nombre.ToUpper().Contains(filtro.ToUpper())).ToList();
                }
            }
        ...
        public bool GuardarRegistro(tb_programa registro)
        {
            try
            {
                using (SoftwareBDEntities bd = new SoftwareBDEntities())
        ...
        public tb_programa BuscarRegistro(int id)
        {
            using (SoftwareBDEntities bd = new SoftwareBDEntities())
            {
        ...
        public bool EditarRegistro(tb_programa registro)
        {
            try
            {
                using (SoftwareBDEntities bd = new SoftwareBDEntities())
