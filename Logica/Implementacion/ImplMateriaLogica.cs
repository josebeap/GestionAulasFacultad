...
namespace Logica.Implementacion
{
    public class ImplMateriaLogica
    {
        ...
        public IEnumerable<MateriaDTO> ListarRegistros(String filtro, int numPagina, int registrosPorPagina, out int totalRegistros)
        {
        ...
        // esto va en producto
        public IEnumerable<MateriaDTO> ListarRegistros()
        {
