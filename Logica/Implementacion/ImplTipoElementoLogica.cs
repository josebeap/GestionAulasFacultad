...
namespace Logica.Implementacion
{
    public class ImplTipoElementoLogica
    {
        ...
        public IEnumerable<TipoElementoDTO> ListarRegistros(String filtro, int numPagina, int registrosPorPagina, out int totalRegistros)
        {
        ...
        // esto va en producto
        public IEnumerable<TipoElementoDTO> ListarRegistros()
        {
